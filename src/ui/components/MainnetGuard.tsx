...
export function MainnetGuard({
  ...
  return (
    <section className="mainnet-guard" aria-label="Mainnet warning">
      ...
      <p>
        IntentProof can review mainnet requests and forward safe requests to
        imToken, but mainnet assets are real. Check full addresses and values.
      </p>
      <p className="small-text">
        Mainnet requests always use the connected wallet for final signing;
        IntentProof never signs mainnet transactions locally. BLOCK requests are
        never forwarded.

...
export type TestnetChainKey = "sepolia" | "baseSepolia";
export type MainnetChainKey = "ethereum" | "base";
export type DemoChainKey = TestnetChainKey | MainnetChainKey;
...
export interface DecodedAction {
  ...
  decodeSource?: "verified" | "registry" | "common" | "selector";
  title: string;
  summary: string;
